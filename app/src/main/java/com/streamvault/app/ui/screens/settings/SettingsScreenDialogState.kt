...
internal class SettingsScreenDialogState(
    ...
    private val showCategoryLanguagePriorityDialogTypeState: MutableState<String?>,
    ...
    var showCategoryLanguagePriorityDialogType by showCategoryLanguagePriorityDialogTypeState
...
internal fun rememberSettingsScreenDialogState(): SettingsScreenDialogState {
    ...
    val showCategoryLanguagePriorityDialogTypeState = rememberSaveable { mutableStateOf<String?>(null) }
    ...
    return SettingsScreenDialogState(
        ...
        showCategoryLanguagePriorityDialogTypeState = showCategoryLanguagePriorityDialogTypeState,
