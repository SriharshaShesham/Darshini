...
val SettingsCardBackground: Color
    @Composable get() {
        val currentPalette = tv.darshini.app.ui.design.LocalAppColors.current
        return when (currentPalette) {
            tv.darshini.app.ui.design.DarkAppColors -> Color.White.copy(alpha = 0.035f)
            tv.darshini.app.ui.design.GlassDarkAppColors -> Color.White.copy(alpha = 0.035f)
            tv.darshini.app.ui.design.GlassLightAppColors -> Color.White.copy(alpha = 0.30f)
            else -> Color.White
        }
    }
...
val DialogBackground: Color
    @Composable get() {
        val currentPalette = tv.darshini.app.ui.design.LocalAppColors.current
        val isGlass = currentPalette == tv.darshini.app.ui.design.GlassLightAppColors || currentPalette == tv.darshini.app.ui.design.GlassDarkAppColors
        return if (isGlass) {
