...
import tv.darshini.app.util.OfficialBuildStatus
...
private fun formatExternalPlaybackModeLabel(
    mode: tv.darshini.domain.model.ExternalPlaybackMode,
    context: Context
): String = when (mode) {
    tv.darshini.domain.model.ExternalPlaybackMode.INTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_internal)
    tv.darshini.domain.model.ExternalPlaybackMode.ASK_EVERY_TIME -> context.getString(R.string.settings_external_playback_mode_ask_every_time)
    tv.darshini.domain.model.ExternalPlaybackMode.EXTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_external)
}
