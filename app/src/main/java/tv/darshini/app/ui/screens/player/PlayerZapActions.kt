    ...
    viewModelScope.launch {
        withScopedScrubbingMode(playerEngine::setScrubbingMode) {
            ...
            playerEngine.playbackState
                .filter {
                    it == tv.darshini.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: tv.darshini.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): tv.darshini.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): tv.darshini.domain.model.Channel? {
...
internal fun PlayerViewModel.resolveChannelNumber(
    channel: tv.darshini.domain.model.Channel,
    index: Int
