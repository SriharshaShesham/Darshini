...
internal fun observeSettingsPreferenceSnapshot(
    ...
    return combine(
        ...
        SettingsPreferenceSnapshot(
            ...
            playerSurfaceMode = tv.darshini.domain.model.PlayerSurfaceMode.AUTO,
            ...
            providerSyncCadence = SyncCadence.DEFAULT,
    ...
    }.combine(preferencesRepository.providerSyncCadence) { snapshot, providerSyncCadence ->
        snapshot.copy(providerSyncCadence = providerSyncCadence)
    ...
    }.combine(preferencesRepository.categoryLanguagePriority) { snapshot, priority ->
        snapshot.copy(categoryLanguagePriority = priority)
    }
}
