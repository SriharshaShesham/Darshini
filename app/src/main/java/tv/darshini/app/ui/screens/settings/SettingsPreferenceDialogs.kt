...
import tv.darshini.app.ui.screens.dashboard.DashboardShelfCustomizationDialog
        ...
        if (type != null) {
            CategorySortModeDialog(
                ...
                onModeSelected = { mode ->
                    ...
                    if (mode == CategorySortMode.CUSTOM) {
                        onShowCategoryLanguagePriorityDialogTypeChange(type.name)
                    }
                }
            )
        }
