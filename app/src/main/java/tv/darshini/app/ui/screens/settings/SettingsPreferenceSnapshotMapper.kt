...
internal fun SettingsUiState.applyPreferenceSnapshot(snapshot: SettingsPreferenceSnapshot): SettingsUiState {
    ...
    return copy(
        ...
        useSideNavigation = snapshot.useSideNavigation,
        syncOnStartSections = snapshot.syncOnStartSections,
        ...
        providerSyncCadence = snapshot.providerSyncCadence,
        ...
        categoryLanguagePriority = snapshot.categoryLanguagePriority
    )
}
