...
import tv.darshini.app.ui.components.ContinueWatchingRow
import tv.darshini.app.ui.components.SavedCategoryContextCard
import tv.darshini.app.ui.components.SavedCategoryShortcut
import tv.darshini.app.ui.components.SavedCategoryShortcutsRow
import tv.darshini.app.ui.components.SelectionChip
import tv.darshini.app.ui.components.SelectionChipRow
import tv.darshini.app.ui.components.SeriesCard
...
import tv.darshini.app.ui.components.dialogs.DeleteGroupDialog
import tv.darshini.app.ui.components.dialogs.RenameGroupDialog
import tv.darshini.app.ui.components.shell.BrowseHeroPanel
import tv.darshini.app.ui.components.shell.BrowseSearchLaunchCard
import tv.darshini.app.ui.components.shell.LoadMoreCard
import tv.darshini.app.ui.components.shell.InfiniteScrollEffect
import tv.darshini.app.ui.components.shell.AppNavigationChrome
import tv.darshini.app.ui.components.shell.AppMessageState
import tv.darshini.app.ui.components.shell.AppScreenScaffold
import tv.darshini.app.ui.components.shell.VodActionChip
import tv.darshini.app.ui.components.shell.VodActionChipRow
import tv.darshini.app.ui.components.shell.VodCategoryOption
import tv.darshini.app.ui.components.shell.VodCategoryPickerDialog
import tv.darshini.app.ui.components.shell.VodBrowseOptionsDialog
import tv.darshini.app.ui.components.shell.VodClassicCategoryOption
import tv.darshini.app.ui.components.shell.VodClassicContentHeader
import tv.darshini.app.ui.components.shell.VodClassicSplitLayout
import tv.darshini.app.ui.components.shell.VodHeroStrip
import tv.darshini.app.ui.components.shell.CategoryDetailHeader
...
fun SeriesScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        if (uiState.isLoading) {
            ...
            SeriesVodContent(
                ...
                onSyncCategory = viewModel::syncCategory,
                onSyncSelectedCategory = viewModel::syncSelectedCategory,
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        tv.darshini.app.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        tv.darshini.app.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
            ...
            onSyncCategory = if (!category.isVirtual) {
                { viewModel.syncCategory(category) }
            } else null
        )
    }
...
private fun SeriesVodContent(
    ...
    onSyncCategory: (Category) -> Unit,
    onSyncSelectedCategory: () -> Unit,
    ...
    val previewListState = rememberSaveable(saver = androidx.compose.foundation.lazy.LazyListState.Saver) {
    ...
    if (uiState.selectedCategory == null) {
        ...
        val allMatchedSeries = remember(catEntries) {
        ...
        LazyColumn(
                            ...
                            if (freshSeries.isNotEmpty()) {
                                add(
                                    VodActionChip(
                                        ...
                                        label = stringResource(R.string.dashboard_recent_series),
            ...
            if (uiState.searchQuery.isNotBlank()) {
                if (uiState.isLoadingPreviewRows) {
                    ...
                    val chunkedSeries = allMatchedSeries.chunked(6)
                    itemsIndexed(chunkedSeries, key = { index, _ -> "search_row_$index" }) { rowIndex, rowSeries ->
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                ...
                items(catEntries, key = { it.key }) { entry ->
                    ...
                    CategoryRow(
                        ...
                        onSync = matchedCategory?.takeIf { !it.isVirtual && !lockedCategory }?.let { cat ->
                            { onSyncCategory(cat) }
                        },
                        keySelector = { it.id }
                    ) { series ->
    ...
    LazyVerticalGrid(
        ...
        if (uiState.canSyncSelectedCategoryFromServer && !uiState.isLoadingSelectedCategory) {
            item(span = { GridItemSpan(maxLineSpan) }) {
                LoadMoreCard(
                    label = stringResource(R.string.category_load_all_from_server),
                    onClick = onSyncSelectedCategory,
...
private fun seriesLibraryLensLabel(lens: SeriesLibraryLens): String =
    when (lens) {
        ...
        SeriesLibraryLens.TOP_RATED -> ""
        SeriesLibraryLens.FRESH -> stringResource(R.string.dashboard_recent_series)
    }
