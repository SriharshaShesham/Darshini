...
import tv.darshini.app.localization.localeForLanguageTag
import tv.darshini.app.localization.supportedAppLanguageTags
...
import tv.darshini.domain.model.RemoteShortcutSelectionMode
...
internal fun sortModeLabel(mode: CategorySortMode, context: android.content.Context): String {
    return when (mode) {
        ...
        CategorySortMode.CUSTOM -> context.getString(R.string.settings_category_sort_custom)
    }
}
