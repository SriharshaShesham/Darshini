...
internal fun LazyListScope.settingsAboutSection(
    ...
    item {
        ...
        LaunchedEffect(downloadStatus) {
            if (downloadStatus == tv.darshini.app.update.AppUpdateDownloadStatus.Downloading) {
                while (true) {
    ...
    item {
        ...
        ClickableSettingsRow(
            label = stringResource(R.string.settings_github_darshini),
            value = stringResource(R.string.settings_github_darshini_url),
            onClick = { onOpenUri(context.getString(R.string.settings_github_darshini_url)) }
        )
        ClickableSettingsRow(
