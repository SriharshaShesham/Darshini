    ...
    PremiumDialog(
        ...
        content = {
            ...
            displayDestinations.forEachIndexed { index, destination ->
                val isFixed = destination == AppTopLevelDestination.HOME
                    || destination == AppTopLevelDestination.SEARCH
                    || destination == AppTopLevelDestination.SETTINGS
                TopNavigationDialogRow(
                    destination = destination,
                    enabled = destination in draftDestinations,
                    canMoveUp = !isFixed
                        && index > 0
                        && displayDestinations.getOrNull(index - 1) != AppTopLevelDestination.HOME,
                    canMoveDown = !isFixed
                        && index < displayDestinations.lastIndex
                        && displayDestinations.getOrNull(index + 1)
                            .let { it != AppTopLevelDestination.SETTINGS && it != AppTopLevelDestination.SEARCH },
