package tv.darshini.app.plugins

object StreamVaultPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "tv.darshini.plugin.API"
    const val META_MANIFEST_JSON = "tv.darshini.plugin.MANIFEST_JSON"
    const val META_ID = "tv.darshini.plugin.ID"
    const val META_NAME = "tv.darshini.plugin.NAME"
    const val META_VERSION_NAME = "tv.darshini.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "tv.darshini.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "tv.darshini.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "tv.darshini.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "tv.darshini.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "tv.darshini.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "tv.darshini.plugin.PROVIDER_NAME"
