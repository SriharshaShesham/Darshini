...
import tv.darshini.data.remote.http.DefaultUserAgentInterceptor
import tv.darshini.data.remote.http.buildAppRequestProfile
import tv.darshini.data.remote.http.buildAppUserAgent
import tv.darshini.data.remote.stalker.OkHttpStalkerApiService
...
import tv.darshini.player.PlaybackSupportSnapshotStore
...
object NetworkModule {
    ...
    fun provideMainPlayerEngine(
        ...
        playbackCompatibilityRepository: tv.darshini.domain.repository.PlaybackCompatibilityRepository,
