package tv.darshini.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import tv.darshini.data.local.entity.*
import tv.darshini.data.remote.stalker.StalkerPlaybackDescriptor
import tv.darshini.data.remote.stalker.StalkerUrlFactory
import tv.darshini.data.remote.xtream.XtreamStreamKind
import tv.darshini.data.remote.xtream.XtreamUrlFactory
import tv.darshini.domain.model.*
...
fun CategoryEntity.toDomain() = tv.darshini.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun tv.darshini.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { tv.darshini.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(tv.darshini.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = tv.darshini.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun tv.darshini.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun tv.darshini.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    tv.darshini.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun tv.darshini.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = tv.darshini.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = tv.darshini.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { tv.darshini.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(tv.darshini.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { tv.darshini.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun tv.darshini.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
