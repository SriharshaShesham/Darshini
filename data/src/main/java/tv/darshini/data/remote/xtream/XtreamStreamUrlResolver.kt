...
import tv.darshini.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import tv.darshini.data.remote.stalker.StalkerPlaybackResolutionException
...
import tv.darshini.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is tv.darshini.domain.model.Result.Success -> resolvedResult.data
                    is tv.darshini.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = tv.darshini.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: tv.darshini.data.remote.stalker.StalkerPlaybackInfo
    ) {
