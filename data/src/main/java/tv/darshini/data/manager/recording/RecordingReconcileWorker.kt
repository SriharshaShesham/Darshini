...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): tv.darshini.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            ...
            is tv.darshini.domain.model.Result.Error -> Result.retry()
            tv.darshini.domain.model.Result.Loading -> Result.retry()
        }
    }
