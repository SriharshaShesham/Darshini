package tv.darshini.data.manager.reminder

import android.content.BroadcastReceiver
import android.content.Context
import android.content.Intent
import tv.darshini.data.manager.ProgramReminderManagerImpl
...
class ProgramReminderAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_NOTIFY_REMINDER = "tv.darshini.data.reminder.action.NOTIFY"
