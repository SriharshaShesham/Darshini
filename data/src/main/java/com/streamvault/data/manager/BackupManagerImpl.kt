...
class BackupManagerImpl @Inject constructor(
    ...
    override suspend fun exportProvider(providerId: Long, uriString: String): com.streamvault.domain.model.Result<Unit> = withContext(Dispatchers.IO) {
        try {
            val providerEntity = providerDao.getById(providerId)
                ?: return@withContext com.streamvault.domain.model.Result.error("Provider not found")
            ...
            com.streamvault.domain.model.Result.error("Failed to export provider: ${e.message}", e)
        }
    }
