...
import tv.darshini.data.local.dao.PlaybackCompatibilityDao
import tv.darshini.data.local.entity.PlaybackCompatibilityRecordEntity
...
class PlaybackCompatibilityRepositoryImplTest {
    ...
    private fun readDaoSource(): String {
        val candidates = listOf(
            Paths.get("src", "main", "java", "tv", "darshini", "data", "local", "dao", "Daos.kt"),
            Paths.get("data", "src", "main", "java", "tv", "darshini", "data", "local", "dao", "Daos.kt")
        )
