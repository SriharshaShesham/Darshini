...
import tv.darshini.data.local.entity.EpisodeBrowseEntity
import tv.darshini.data.local.entity.EpisodeEntity
import tv.darshini.data.local.entity.SeriesEntity
import tv.darshini.data.local.entity.SeriesBrowseEntity
...
import tv.darshini.data.remote.dto.XtreamSeason
import tv.darshini.data.remote.dto.XtreamSeriesInfoResponse
import tv.darshini.data.remote.stalker.StalkerCategoryRecord
import tv.darshini.data.remote.stalker.StalkerEpisodeRecord
...
import tv.darshini.data.remote.stalker.StalkerSeasonRecord
import tv.darshini.data.remote.stalker.StalkerSeriesDetails
...
import tv.darshini.domain.model.VodDuplicateConfidence
import tv.darshini.domain.model.VodDuplicateHandlingMode
import tv.darshini.domain.model.VodSeriesVariant
...
class SeriesRepositoryImplTest {
    ...
    fun `stalker series preview loads only first page`() = runTest {
        ...
        whenever(categoryDao.getByProviderAndType(7L, ContentType.SERIES.name)).thenReturn(
            flowOf(listOf(tv.darshini.data.local.entity.CategoryEntity(providerId = 7L, categoryId = 77L, name = "Drama", type = ContentType.SERIES)))
        )
        whenever(providerDao.getById(7L)).thenReturn(
            ProviderEntity(
                id = 7L,
    ...
    fun `getSeriesDetails falls back to remote series id lookup`() = runTest {
        ...
        assertThat(result).isInstanceOf(tv.darshini.domain.model.Result.Success::class.java)
        val series = (result as tv.darshini.domain.model.Result.Success).data
