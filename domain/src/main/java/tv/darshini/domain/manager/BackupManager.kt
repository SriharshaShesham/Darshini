...
data class BackupData(
    ...
    val favorites: List<tv.darshini.domain.model.Favorite>? = null,
    val virtualGroups: List<tv.darshini.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): tv.darshini.domain.model.Result<Unit>
    ...
    /**
     * Exports a single provider's details to the provided URI string.
     */
    suspend fun exportProvider(providerId: Long, uriString: String): tv.darshini.domain.model.Result<Unit>
}
